...
namespace TranslatorAPI
{
    public partial class TranslatorAPI : Form
    {
            ...
            if (result != null)
            {
                switch (mode)
                {
                    ...
                    case 2:
                        ...
                        Azure_Translator_Service.translationsResponse json2 = JsonConvert.DeserializeObject<Azure_Translator_Service.translationsResponse>(result);
                    ...
                    case 4:
                        ...
                        Azure_Translator_Service.examplesresponse json4 = JsonConvert.DeserializeObject<Azure_Translator_Service.examplesresponse>(result);

                        // Display the examples
                        foreach (Azure_Translator_Service.example ex in json4.examples)
                        {
        ...
        private void TranslatorAPI_Load_1(object sender, EventArgs e)
        {
        ...
        private void TranslatorAPI_FormClosed(object sender, FormClosedEventArgs e)
        {
            client.Close();
        }
    }
